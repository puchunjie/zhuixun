			        ...
			        if (res.data.code === 0) {
						...
						if(this.shop != null){
							...
							if(this.shop.shopPicList != null && this.shop.shopPicList.length > 0){
								for (let pic in this.shop.shopPicList) {
									pic.picUrl = this.imgUrl + pic.picUrl;
								}
							}
							if(this.shop.shopVideoList != null && this.shop.shopVideoList.length > 0){
								for (let video in this.shop.shopVideoList) {
									video.videoUrl = this.imgUrl + video.videoUrl;
								}
							}
						}
			        }
